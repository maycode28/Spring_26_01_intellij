			...
			<table class="table" border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
				<tbody>
					...
					<tr>
						<th>비밀번호 확인</th>
						<td style="text-align: center;">
							<input class="input input-neutral" name="loginPwChk" autocomplete="off" type="text" placeholder="비번확인 입력" />
						</td>
					</tr>
					<tr>
						<th>이름</th>
					...
					<tr>
						<th>별명</th>
						<td style="text-align: center;">
							<input class="input input-neutral" name="nickname" autocomplete="off" type="text" placeholder="별명 입력" />
						</td>
					</tr>
					<tr>
						<th>전화번호</th>
